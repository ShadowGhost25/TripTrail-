        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <ul className="mt-6 space-y-4 text-sm">
                <li className="hover:opacity-75 transition">
                  <Link
                ...
                <li className="flex items-start justify-center gap-1.5 transition hover:opacity-75 ltr:sm:justify-start rtl:sm:justify-end">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="size-5 shrink-0 text-gray-900 dark:text-gray-200"
                    fill="none"
                  ...
                  <address className="-mt-0.5 flex-1 not-italic text-gray-700 hover:opacity-75 dark:text-gray-400">
                    412421 Россия, Пенза
                  </address>
                </li>
              </ul>
